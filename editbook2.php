...
$parameter = $_GET['kode_cust'];
$query = "SELECT * FROM ticket WHERE id_cust = " . $parameter;
...
if ($query = mysqli_query($koneksi, $query)) {
    ...
    echo "hehe datanya gajelas $query";
}
...
?>
        ...
        <form data-aos="fade-center" action="/heaventour/database/update2.php" method="POST">

            <div class="segment">
                <h1>Sunting Booking Form HeavenTour</h1>
            </div>

            <input type="hidden" name="kode_cust" value="<?php echo $_GET['kode_cust']?>">

            <label for="">
                <input type="number" name="jumlahorang" placeholder="Jumlah Orang ..." value="<?php echo $row['jumlah_orang']; ?>">
            </label>
            ...
            <label for="">
                <select name="paket" id="">
                    ...
                    <option                    
                    <?php
                        if ($row['paket_tour'] == 'Heaven') {
                        echo "selected";
                        }
                    ?>
                    value="Heaven" id="jk">Heaven</option>
                    <option 
                    <?php
                        if ($row['paket_tour'] == 'Sky') {
                        echo "selected";
                        }
                    ?>
                    value="Sky" id="jk">Sky</option>
                    <option
                    <?php
                        if ($row['paket_tour'] == 'Earth') {
                        echo "selected";
                        }
                    ?>
                    value="Earth" id="jk">Earth</option>
            ...
            <label for="">
                ...
                <input type="date" name="tanggalberangkat" placeholder="Tanggal Berangkat" value="<?php echo $row['tanggal_berangkat']; ?>">
            </label>
