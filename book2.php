...
<body>
    ...
    <main id="main">
        ...
        <form data-aos="fade-center" action="/heaventour/database/simpandatabooking2.php" method="POST">
            ...
            <input type="hidden" name="id_cust" value="<?php echo $_GET ['kode_cust']?>">
            ...
            <button class="red" type="submit"><i class="icon ion-md-lock"></i>Book!</button>
