...
<body>
    ...
    <main id="main">
        ...
        <form data-aos="fade-center" action="/heaventour/database/update.php" method="POST">

            <div class="segment">
                <h1>Sunting Booking Form HeavenTour</h1>
            </div>
            <input type="hidden" name="id_cust" value="<?php echo $_GET['id_cust']?>">
            <input type="hidden" name="kode_cust" value="<?php echo $row['kode_cust']?>">
            <label>
                <input name="nama" type="text" placeholder="Nama" value="<?php echo $row['cust_name']; ?>" />
            </label>
            <label>
                <input name="email" type="email" placeholder="Email" value="<?php echo $row['cust_email']; ?>"/>
            </label>
            <label>
                <input name="telepon" type="number" placeholder="Nomor Telepon" value="<?php echo $row['cust_contact']; ?>" />
            </label>
            <label for="" >
                <input name="age" type="Number" placeholder="Umur" value="<?php echo $row['cust_age']; ?>">
            </label>
            <label for="">
            ...
            <button class="red" type="submit"><i class="icon ion-md-lock"></i>Update Next</button>
